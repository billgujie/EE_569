...

{
	...
	unsigned char ImagedataF[256][256];
	float ImagedataDx[256][256];
	unsigned char ImagedataDx_int[256][256];
	float ImagedataDy[256][256];
	unsigned char ImagedataDy_int[256][256];
	float ImagedataMag[256][256];
	unsigned char ImagedataMag_int[256][256];
	...
	if (!(file=fopen((savename+"_dFdy"+".raw").c_str(),"wb"))) {
		cout << "Cannot open file: " << argv[2] << endl;
		exit(1);
	}
	fwrite(ImagedataDy_int, sizeof(unsigned char), 256*256, file);
	fclose(file);
	return 0;
}
